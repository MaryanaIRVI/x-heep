...
# SPI
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports {spi_csb_o[1]}] ;
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {spi_csb_o[0]}] ; 
...
set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports {spi_sd_io[3]}] ; # arduino_gpio_tri_io[13]
...
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {gpio_io[7]}] ; # rpi_gpio_tri_io[1]
...
# Tri-color LEDs for TARGET_PYNQ_Z2 --ELIMINAR SI ES NECESARIO
