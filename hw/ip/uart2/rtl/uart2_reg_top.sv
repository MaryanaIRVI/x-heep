...
module uart2_reg_top #(
  ...
  always_comb begin
    addr_hit = '0;
    addr_hit[0] = (reg_addr == UART2_INTR_STATE_OFFSET);
    addr_hit[1] = (reg_addr == UART2_INTR_ENABLE_OFFSET);
    addr_hit[2] = (reg_addr == UART2_INTR_TEST_OFFSET);
    addr_hit[3] = (reg_addr == UART2_CTRL_OFFSET);
    addr_hit[4] = (reg_addr == UART2_STATUS_OFFSET);
    addr_hit[5] = (reg_addr == UART2_RDATA_OFFSET);
    addr_hit[6] = (reg_addr == UART2_WDATA_OFFSET);
    addr_hit[7] = (reg_addr == UART2_FIFO_CTRL_OFFSET);
    addr_hit[8] = (reg_addr == UART2_FIFO_STATUS_OFFSET);
    addr_hit[9] = (reg_addr == UART2_OVRD_OFFSET);
    addr_hit[10] = (reg_addr == UART2_VAL_OFFSET);
    addr_hit[11] = (reg_addr == UART2_TIMEOUT_CTRL_OFFSET);
  end
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[ 0] & (|(UART2_PERMIT[ 0] & ~reg_be))) |
               (addr_hit[ 1] & (|(UART2_PERMIT[ 1] & ~reg_be))) |
               (addr_hit[ 2] & (|(UART2_PERMIT[ 2] & ~reg_be))) |
               (addr_hit[ 3] & (|(UART2_PERMIT[ 3] & ~reg_be))) |
               (addr_hit[ 4] & (|(UART2_PERMIT[ 4] & ~reg_be))) |
               (addr_hit[ 5] & (|(UART2_PERMIT[ 5] & ~reg_be))) |
               (addr_hit[ 6] & (|(UART2_PERMIT[ 6] & ~reg_be))) |
               (addr_hit[ 7] & (|(UART2_PERMIT[ 7] & ~reg_be))) |
               (addr_hit[ 8] & (|(UART2_PERMIT[ 8] & ~reg_be))) |
               (addr_hit[ 9] & (|(UART2_PERMIT[ 9] & ~reg_be))) |
               (addr_hit[10] & (|(UART2_PERMIT[10] & ~reg_be))) |
               (addr_hit[11] & (|(UART2_PERMIT[11] & ~reg_be)))));
  end
