...
module uart2_core (
    ...
    input  uart2_reg_pkg::uart2_reg2hw_t reg2hw,
    output uart2_reg_pkg::uart2_hw2reg_t hw2reg,
  ...
  logic uart2_fifo_rxrst, uart2_fifo_txrst;
  logic [2:0] uart2_fifo_rxilvl;
  logic [1:0] uart2_fifo_txilvl;
  logic ovrd_tx_en, ovrd_tx_val;
  logic [7:0] tx_fifo_data;
  logic tx_fifo_rready, tx_fifo_rvalid;
  logic tx_fifo_wready, tx_uart2_idle;
  logic       tx_out;
  logic       tx_out_q;
  logic [7:0] rx_fifo_data;
  logic rx_valid, rx_fifo_wvalid, rx_fifo_rvalid;
  logic rx_fifo_wready, rx_uart2_idle;
  logic rx_sync;
  logic rx_in;
  logic break_err;
  ...
  assign uart2_fifo_rxrst  = reg2hw.fifo_ctrl.rxrst.q & reg2hw.fifo_ctrl.rxrst.qe;
  assign uart2_fifo_txrst  = reg2hw.fifo_ctrl.txrst.q & reg2hw.fifo_ctrl.txrst.qe;
  assign uart2_fifo_rxilvl = reg2hw.fifo_ctrl.rxilvl.q;
  assign uart2_fifo_txilvl = reg2hw.fifo_ctrl.txilvl.q;
  ...
  assign allzero_cnt_d = (break_st_q == BRK_WAIT || not_allzero_char) ? 5'h0 :
      ...
      allzero_err ? allzero_cnt_q + 5'd1 : allzero_cnt_q;
  ...
  assign hw2reg.rdata.d             = uart2_rdata;

  assign hw2reg.status.rxempty.d    = ~rx_fifo_rvalid;
  assign hw2reg.status.rxidle.d     = rx_uart2_idle;
  assign hw2reg.status.txidle.d     = tx_uart2_idle & ~tx_fifo_rvalid;
  ...
  assign tx_fifo_rready = tx_uart2_idle & tx_fifo_rvalid & tx_enable;
  ...
  // would trigger an empty.  This is due to the fact that the uart2_tx fsm immediately
  ...
  assign event_tx_empty     = ~tx_fifo_rvalid & ~tx_uart2_idle_q & tx_uart2_idle;
  ...
  assign uart2_rxto_en = reg2hw.timeout_ctrl.en.q;
  assign uart2_rxto_val = reg2hw.timeout_ctrl.val.q;
  ...
  assign rx_timeout_count_d =
      ...
      //(rx_timeout_count_q == uart2_rxto_val) ? rx_timeout_count_q :
      // increment if at rx baud tick
      rx_tick_baud ? (rx_timeout_count_q + 24'd1) : rx_timeout_count_q;

  assign event_rx_timeout = (rx_timeout_count_q == uart2_rxto_val) & uart2_rxto_en;
